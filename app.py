...
# --- PAGE CONFIGURATION ---
st.set_page_config(page_title="CRUSH Sales Call Guide", page_icon="📞", layout="centered")
...
- Provide 2-3 bullet points on how to open the call.
- Include a specific question to confirm they are actually at **{cdm_stage}**.
- Include a question to confirm their role as **{rubie_role}**.
...
- Provide 3 specific "Harmonization" questions to uncover internal friction, dependencies, or shadow processes.
- **Closing Question:** Provide the exact script for the "Consolidate Clarity" close (e.g., "Based on this, what do you need from us...?").

"""

# --- LOGIC MAPPING ---
# Maps RUBIE Roles to the specific focus areas defined in the Call Guide
ROLE_LOGIC_MAP = {
...
st.markdown("Generates a **decision-alignment script** for a specific stakeholder.")
...
if submit:
    if not customer_name or not context:
        ...
        with st.spinner("Drafting Call Guide..."):
            ...
            # Copy Button Logic (Simple text area for now)
